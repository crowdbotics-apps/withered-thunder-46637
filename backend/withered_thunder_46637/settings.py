"""
Django settings for withered_thunder_46637 project.
...
ROOT_URLCONF = 'withered_thunder_46637.urls'
...
WSGI_APPLICATION = 'withered_thunder_46637.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_thunder_46637 API",
    "DESCRIPTION": "API documentation for withered_thunder_46637 App",
    "VERSION": "v1",
}
